...
add_car_movable_constraint_set :: proc(constraints: ^Constraints, car: ^Car_Entity, entity_b_lookup: Entity_Lookup, rigid_body_b: ^Rigid_Body_Entity, manifold: ^Contact_Manifold, dt: f32) {
	n := manifold.normal;
	t1, t2 := math2.vector3_tangents(n);
